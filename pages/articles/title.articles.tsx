...
export default function TitleArticles() {
    return (
        <Head>
            ...
            <title>Articles by Dylan Marsili</title>
            <meta name="description" content="Explore articles authored by Dylan Marsili, a Full Stack Engineer and Developer." />
