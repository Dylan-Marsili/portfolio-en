...
export default function Title500() {
    return (
        <Head>
            ...
            <title>500: internal server error | Dylan Marsili</title>
            ...
            <meta name="keywords" content="500, internal server error, Dylan Marsili, Portfolio,broken link ,missing page,link not found" />
